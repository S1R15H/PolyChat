  ...
  const handleSignup = (e) => {
    ...
    signupMutation(signupData, {
      onError: () => {
        ...
        setSignupData(prev => ({ ...prev, captchaToken: "" }));
      }
    });
  };
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm opacity-70">
                    Join Chatapp and start your language learning journey today!
                  </p>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="w-full flex justify-center mb-4">
                    <Turnstile
                      ...
                      onSuccess={(token) => setSignupData({ ...signupData, captchaToken: token })}
                ...
                <button
                  ...
                  type="submit"
                  disabled={isPending || !signupData.captchaToken} // Disable until verified
                >
                  {isPending ? (
                    <>
